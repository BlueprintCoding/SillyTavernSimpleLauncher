...
description_label.grid(row=0, column=0, columnspan=2, pady=10, sticky="nw")
...
label2.grid(row=0, column=1, padx=10, pady=10, sticky="ne")
...
launch_frame.grid(row=1, column=0, padx=10, pady=10, sticky="nw")
...
instructions_label.grid(row=2, column=0, columnspan=2, padx=10, pady=10, sticky="nw")
...
uninstall_frame.grid(row=4, column=0, padx=10, pady=10, sticky="nw")
...
support_frame.grid(row=4, column=1, padx=10, pady=10, sticky="nw")
...
install_paths_frame.grid(row=5, column=0, columnspan=2, padx=10, pady=10, sticky="nw")
