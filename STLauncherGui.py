...
description_label = tk.Label(root, text="Script Launcher", bg='#36393f', fg='white', font=("Helvetica", 16, "bold"))
description_label.grid(row=0, column=0, columnspan=3, pady=10, sticky="nw")

# Add an instructions label
instructions_label = tk.Label(root, text="Instructions: Use the following buttons to install and manage SillyTavern and it's dependencies. \nThe install scripts must be run in order and you must wait for each command prompt to finish before running the next step.", bg='#36393f', fg='white', font=("Helvetica", 12, "bold"), justify="left")
instructions_label.grid(row=2, column=0, columnspan=3, pady=(10, 0), sticky="nw")
...
launch_frame.grid(row=1, column=0, columnspan=3, padx=10, pady=10, sticky="nw")
...
support_frame.grid(row=1, column=1, padx=10, pady=10, sticky="nw")
...
button1.grid(row=0, column=0, columnspan=3, padx=5, pady=5, sticky="nw")
...
install_frame.grid(row=3, column=0, padx=10, pady=10, sticky="nw")
...
tools_frame.grid(row=3, column=1, padx=10, pady=10, sticky="nw")
...
uninstall_frame.grid(row=3, column=2, padx=10, pady=10, sticky="ne")
...
install_paths_frame = tk.Frame(root, bg='#36393f', padx=10, pady=10)
install_paths_frame.grid(row=4, column=0, columnspan=3, pady=10, sticky="nw")
