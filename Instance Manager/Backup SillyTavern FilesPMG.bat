...
if exist "%main_branch%" (
    ...
    echo MainBranch folder does not exist. Skipping backup from MainBranch.
)
...
if exist "%dev_branch%" (
    ...
    echo DevBranch folder does not exist. Skipping backup from DevBranch.
)
